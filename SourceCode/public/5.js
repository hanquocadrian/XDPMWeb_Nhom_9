  ...
  _createClass(AddRates, [{
    ...
    value: function handleChange(e) {
      if (e.target.name == "timeApDung") {
        ...
        console.log(Object(date_fns__WEBPACK_IMPORTED_MODULE_12__["differenceInDays"])(new Date(e.target.value), new Date()));

        if (Object(date_fns__WEBPACK_IMPORTED_MODULE_12__["differenceInDays"])(new Date(e.target.value), new Date()) < 0) {
